...
if DbReachable; then
    ...
    i=0
    ## TODO will be necessary add the check  a count of itteration

    while ! mysqladmin ping -h database_server -p${MYSQL_ROOT_PASSWORD}  --silent; do
        sleep 1
    done
	...
	crontab -l -u www-data | {
		cat
		printf "MAILFROM=cron@domain.com\nMAILTO=root@treolabs.com\n"
	} | crontab -u www-data -
